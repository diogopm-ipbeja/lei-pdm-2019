...
/**
 * Interface base para os DAOs. Esta interface NÃO É um DAO e não deve ser anotada como tal mas devem anotar-se os métodos.
 * Cada DAO deve estender (se for ele próprio uma interface) ou implementar (se for uma classe abstracta) este BaseDao
